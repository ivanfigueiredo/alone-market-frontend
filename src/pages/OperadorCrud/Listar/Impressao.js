    ...
    Body () {
        ...
        this.dadosParaImpressao.forEach(item => {
            tableContent.push([
                ...
                { text: item.eAdmin, fontSize: 10, alignment: "center" }
        ...
        const documentDefinition = {
            ...
            content: [
                        ...
                        },
                        {
                            ...
                            text: '\nRELATÓRIO DE USUÁRIO', style: {fontSize: 14, alignment: 'center', bold: true},
                        },
                        
                        {
                            ...
                            table: {
                                ...
                                body: [
                                    ...
                                    [{text: 'Nome', style: {fontSize: "12", bold: true, alignment: "center"}, margin: [70, 0]}, 
                                     {text: 'Status', style: {fontSize: "12", bold: true, alignment: "center"}, margin: [71, 0]},
                                     {text: 'Permissao', style: {fontSize: "12", bold: true, alignment: "center"}, margin: [71, 0]}],
                                    ...formattedBody,
