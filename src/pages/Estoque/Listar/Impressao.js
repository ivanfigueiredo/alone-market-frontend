    ...
    async PreparaDocumento() {
      ...
      Documento () {
        ...
        this.dadosParaImpressao.forEach(item => {
            tableContent.push([
                { text: item.codigoDeBarras, fontSize: 8, alignment: "left"},
                { text: item.name, fontSize: 8, alignment: "left" },
                { text: item.fornecedor, fontSize: 8, alignment: "left" },
                { text: item.fabricante, fontSize: 8, alignment: "left" },
                { text: item.qtd, fontSize: 8, alignment: "center" },
                { text: item.qtdMinima, fontSize: 8, alignment: "center" },
                { text: "R$ " + item.preco, fontSize: 8, alignment: "left" },
                { text: "R$ " + (parseFloat(item.preco) * item.qtd).toFixed(2), fontSize: 8, alignment: "left" },
        ...
        const documentDefinition = {
            ...
            content: [
                ...
                },
                {
                    ...
                    text: '\nRELATÓRIO DE ESTOQUE', style: {fontSize: 14, alignment: 'center', bold: true},
